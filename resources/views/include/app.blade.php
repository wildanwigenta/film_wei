    ...
    <div class="site-navbar position-fixed" id="navbar" style="transition: 0.3s;width:100%;z-index:100;">
        <nav class="navbar navbar-dark navbar-expand-lg bg-dark ">
            <div class="container-fluid ">
                ...
                <a href="/"><img src="{{ asset('image') }}/logo.png" alt="" width="100px"
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                        <li class="nav-item">
                            <a class="nav-link {{ $navbar == 'home' ? 'active' : '' }}" aria-current="page"
                                href="/"><b>Home</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $navbar == 'popular' ? 'active' : '' }}"
                                href="/popular"><b>Popular</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $navbar == 'top_rated' ? 'active' : '' }}" href="/top_rated"><b>Top
                                    Rated</b></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $navbar == 'now_playing' ? 'active' : '' }}"
                                href="/now_playing"><b>Now Playing</b></a>
                        </li>
